...
public class setDummyUtil {
    ...
    private boolean setDummy = false;        // true 일때 더미 데이터 삽입
    ...
    CommandLineRunner init(
        ...
        return args -> {
            ...
            ecoItems.add(new EcoItem("469", "광동제약(주)", "광동 옥수수수염차 [500mL]", 80L, "환경성적"));
            ecoItems.add(new EcoItem("480", "군자농협 잡곡소포장공장(가공)", "무농약백미4kg", 760L, "친환경인증농산물"));
            ecoItems.add(new EcoItem("487", "네이처홀드", "쑥소쿰 주방세제 750 mL용기", 1120L, "친환경인증농산물"));
