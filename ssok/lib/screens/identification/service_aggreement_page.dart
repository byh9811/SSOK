...
class ServiceAggreementPage extends StatefulWidget {
  final void Function() onTap;
  const ServiceAggreementPage({
    Key? key,
    required this.onTap,
  }) : super(key: key);
  @override
  State<ServiceAggreementPage> createState() => _ServiceAggreementState();
}

class _ServiceAggreementState extends State<ServiceAggreementPage> {
