...
class _BusinessCardPageState extends State<BusinessCardPage> {
  ...
  void isBussinessCard()async{
    final response = await apiService.getRequest("namecard-service/exist", TokenManager().accessToken);
  ...
  Widget build(BuildContext context) {
    return isExistNameCard ? RegisteredBusinessCard() : NotRegisteredBusinessCard();
  }
}
