...
List<ReceiptHistory> parseReceiptHistory(Map<String, dynamic> jsonStr) {
  ...
  if (response != null) {
    response.forEach((key, value) {
      final receiptDetailResponses =
          (value['receiptListQueryResponses'] as List)
...
class _ReceiptHistoryListState extends State<ReceiptHistoryList> {
  ...
  Widget build(BuildContext context) {
    ReceiptHistory selectedReceiptHistory =
        receiptHistories.firstWhere((history) {
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Column(
                                children: [
                                  Text(
                                    "사용 합계 ${numberFormat.format(selectedReceiptHistory.totalPay)}원",
                                    style: TextStyle(
                                      fontSize: 15,
                                      fontWeight: FontWeight.w500,
                                    ),
                  ...
                  SizedBox(
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ReceiptDetail detailData = selectedReceiptHistory
                            .receiptDetailResponses[index];
                        String receiptDetailDocumentId =
                            detailData.receiptDetailDocumentId;
                        String shopName = detailData.shopName;
                        String approvedDate = DateFormat("yyyy-MM-dd HH:mm:ss")
                            .format(DateTime.parse(detailData.approvedDate)
